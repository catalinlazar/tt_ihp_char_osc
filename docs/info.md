...
## How it works
Four 31-stage ring oscillators are implemented using specific IHP SG13G2 standard cells. 
...
2. Set ui_in[1] high to enable oscillation. 
3. Cycle through ui_in[5:4] to select different oscillators. 
4. Cycle through ui_in[3:2] to read the Low, Mid, and High bytes of the frequency on uo_out.
